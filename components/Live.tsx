import { useBroadcastEvent, useEventListener, useMyPresence, useOther, useOthers } from "@liveblocks/react"
...
const Live = () => {
    ...
    const setReactions = useCallback((reaction: string) => {
        setCursorState({ mode: CursorMode.Reaction, reaction , 
        isPressed:false})
    }, [])
  ...
  return (
    ...
    >
        <h1 className="text-2xl text-white ">LiveBlocs Figma Clone </h1>
